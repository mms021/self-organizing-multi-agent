...
Проекты пока только **открытые**: `project_id` группирует записи, но не изолирует их. Закрытые (RFC-1250 §5-§8, membership) отклоняются, чтобы не обещать приватность, которой нет.
